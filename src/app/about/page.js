      ...
      <div className="container-xxl py-5">
        <div className="container">
          <div className="pricing-header p-3 pb-md-4 mx-auto text-center">
            <h1 className="display-6 fw-normal text-body-emphasis">關於美亞</h1>
          </div>
                    ...
                    <div className="col-xs-12 col-md-6">
                      ...
                      <div>
                        <h2 className="h1 mb-3">
                          <p className="fs-3 text-secondary mb-1">由來</p>
                        </h2>
                        <p className="mb-4">
                          美亞廚具（Meyer
                ...
                <div className="col-12">
                  <div className="row align-items-center flex-row-reverse gy-3 gy-md-0 gx-xl-5">
                    ...
                    <div className="col-xs-12 col-md-6">
                      ...
                      <div>
                        <h2 className="h1 mb-3">
                          <p className="fs-3 text-secondary mb-1">盡心</p>
                        </h2>
                        <p className="mb-4">
                ...
                <div className="col-12 bg-light">
                  <div className="row align-items-center gy-3 gy-md-0 gx-xl-5">
                    ...
                    <div className="col-xs-12 col-md-6">
                      ...
                      <div>
                        <h2 className="h1 mb-3">
                          <p className="fs-3 text-secondary mb-1">進取</p>
                        </h2>
                        <p className="mb-4">
                ...
                <div className="col-12">
                  <div className="row align-items-center flex-row-reverse gy-3 gy-md-0 gx-xl-5">
                    ...
                    <div className="col-xs-12 col-md-6">
                      ...
                      <div>
                        <h2 className="h1 mb-3">
                          <p className="fs-3 text-secondary mb-1">追求</p>
                        </h2>
                        <p className="mb-4">
                ...
                <div className="col-12 bg-light">
                  <div className="row align-items-center gy-3 gy-md-0 gx-xl-5">
                    ...
                    <div className="col-xs-12 col-md-6">
                      ...
                      <div>
                        <h2 className="h1 mb-3">
                          <p className="fs-3 text-secondary mb-1">期盼</p>
                        </h2>
                        <p className="mb-4">
